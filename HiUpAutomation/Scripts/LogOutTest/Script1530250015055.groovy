...
Mobile.tap(findTestObject('android.widget.Button0 - Sign out'), 0)

Mobile.tap(findTestObject('android.widget.Button1 - YES'), 0)
Thread.sleep(20000); 
if(Mobile.verifyElementExist(findTestObject('Job_Page'), 10))
{
...
{
	System.out.println("Cannot logged out");
}
